...
test_init_ipfs
test_config_ipfs_gateway_readonly "/ip4/127.0.0.1/tcp/$PORT_GWAY"
...
test_expect_success "GET IPFS path succeeds" '
  ...
  wget "http://127.0.0.1:$PORT_GWAY/ipfs/$HASH" -O actual
'
...
test_expect_success "GET IPFS directory path succeeds" '
  ...
  wget "http://127.0.0.1:$PORT_GWAY/ipfs/$HASH2"
'

test_expect_success "GET IPFS directory file succeeds" '
  wget "http://127.0.0.1:$PORT_GWAY/ipfs/$HASH2/test" -O actual
'
...
test_expect_failure "GET IPNS path succeeds" '
  ...
  wget "http://127.0.0.1:$PORT_GWAY/ipns/$NAME" -O actual
'
...
test_expect_success "GET invalid IPFS path errors" '
  test_must_fail wget http://127.0.0.1:$PORT_GWAY/ipfs/12345
'

test_expect_success "GET invalid path errors" '
  test_must_fail wget http://127.0.0.1:$PORT_GWAY/12345
'
